package com.ajumie.fusiongreenz.Data
...
import com.ajumie.fusiongreenz.models.Product
...
class productviewmodel(var navController: NavHostController, var context: Context) {
    ...
    fun saveProduct(productName: String,  productPrice: String) {
        var id = System.currentTimeMillis().toString()
        var productData = Product(productName,productPrice, id)
    ...
    fun updateProduct(name: String, price: String, id: String) {
        var updateRef = FirebaseDatabase.getInstance().getReference()
            .child("Products/$id")
        progress.show()
        var updateData = Product(name,  price, id)
    ...
    fun saveProductWithImage(productName:String, productPrice: String, filePath: Uri){
        var id = System.currentTimeMillis().toString()
        ...
        storageReference.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageReference.downloadUrl.addOnSuccessListener {
                    ...
                    var houseData = Upload(productName,productPrice,imageUrl,id)
